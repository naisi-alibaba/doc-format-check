...
BUNDLE_ITEMS = ['SKILL.md', 'README.md', 'DESIGN.md', 'LICENSE', 'scripts', 'profiles']
...
USER_TARGETS = {
    ...
    'dsh': os.path.join(HOME, '.dsh', 'skills'),
}
PROJECT_TARGETS = {
...
def main():
    ...
    ap.add_argument('--targets', default='claude,codex,agents,dsh,workbuddy',
